...
Hola de nuevo.
En este artículo, me gustaria mostrar cómo implementar HMR-Hot Module en tu aplicacion de Angular.

Una de las cosas que más puede molestarle a algunos cuando están desarrollando su aplicación de Angular es el reloading de la página cada vez que guardan los cambios, aunque sean mínimos. Este reloading vuelve a cargar la pagina entera, pudiendo a veces, generar un problema en el rendimiento dependiendo de la máquina en la que estemos desarrollando.
...
Hot Module Replacement(HMR) es una característica de Webpack. HMR actualiza tu aplicacion de angular sin que recompile y recargue toda tu proyecto.
